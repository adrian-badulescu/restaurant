    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine();
                Console.WriteLine("You have entered, " + t.tableId + " as your table id !");
            ...
            do
            {
                ...
                Console.Write("Do you want to delete any of these tables y? [y/n]: ");
                Console.ReadLine();
                Console.Write("Which one ? (select index): ");
                TablesLst.RemoveAt(Convert.ToInt32(Console.ReadLine()));
                //Console.ReadLine();                
                Console.Write("Do you want to delete another table y? [y/n]: ");
            ...
            Console.WriteLine("These are the remained tables: ");
